...
//vk_initializers::vk_initializers()
//{
//    //ctor
//}
...
VkPipelineShaderStageCreateInfo vkinit::pipeline_shader_stage_create_info(VkShaderStageFlagBits stage, VkShaderModule shaderModule)
{
    ...
    //shader stage
    info.stage = stage;
    //this module will contain the code for this shader stage
    info.module = shaderModule;
    //this is the entry point for our shaders which is the main() function in our shaders in this case
    info.pName = "main";
    return info;
}
...
VkSubmitInfo vkinit::submit_info(VkCommandBuffer* cmdBuf)
{
    VkSubmitInfo info = {};
